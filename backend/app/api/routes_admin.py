...
SETTING_DEFINITIONS: tuple[SettingDefinition, ...] = (
    SettingDefinition("OPENAI_API_KEY", "ai", "OpenAI API Key", "ChatGPT / LaoZhang API 密钥", is_secret=True),
    SettingDefinition("OPENAI_BASE_URL", "ai", "OpenAI Base URL", "例如 https://api.openai.com/v1 或 LaoZhang API 地址"),
    SettingDefinition("OPENAI_TEXT_MODEL", "ai", "文本模型", "用于标题、关键词、提示词分析", "gpt-4.1-mini"),
    SettingDefinition("OPENAI_IMAGE_MODEL", "ai", "生图模型", "用于 API 生图备选方案", "gpt-image-1"),
